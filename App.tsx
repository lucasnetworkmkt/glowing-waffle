...
import { fetchReservations, createReservation, updateReservationStatusService, checkConnection, fetchAnnouncements, fetchMenu, updateMenuItemPrice, DEFAULT_MENU_ITEMS, createMenuItem } from './services/supabase';
...
const App: React.FC = () => {
  ...
  const handleAddMenuItem = async (item: any) => {
    try {
      ...
      showToast("Novo prato adicionado com sucesso!", "success");
    } catch (e) {
